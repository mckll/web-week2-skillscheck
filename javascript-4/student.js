...
// CODE HERE
let faveColors = ['black', 'green', 'grey'];

//I know two out of three aren't considered colors, but I like them more than colors...so yea.
...
let me = {
  firstname: 'Aaron',
  superHeroName: 'The Mingler',
  homeTown: 'Eavesdropsburgh',
  superPowers: ['listening really, really well', 'ability to infiltrate any conversation', 'never gets cottonmouth'],
