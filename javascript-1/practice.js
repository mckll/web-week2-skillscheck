...
let me = {
	...
	state: 'Pennsylvania',
	age: 31,
	greeter: function() {return `Hello! My name is ${me.name} and I live in ${me.state}`}
}; 
...
// Code Here
let total = myNumbers.reduce(function(sum, num) {
	return sum + num;
});
...
// Code Here
let totallyAwesome = people.reduce(function(total, obj){
